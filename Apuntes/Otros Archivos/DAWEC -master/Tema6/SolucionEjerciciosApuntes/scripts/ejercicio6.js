document.getElementsByTagName('h1')[0].addEventListener('click',invisibilizarParrafos,false);
/**
...
document.getElementsByTagName('label')[3].addEventListener('mouseover',eliminarAtributoName,false);
/**
...
document.getElementsByTagName('h2')[2].addEventListener('mouseover',asignarAtributoNombre,false);
/**
