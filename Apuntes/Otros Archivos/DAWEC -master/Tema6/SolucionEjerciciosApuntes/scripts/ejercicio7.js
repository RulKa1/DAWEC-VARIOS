document.getElementsByClassName('parrafosNormal')[4].addEventListener('click',insertarEncabezadoH2,false);
document.getElementsByClassName('parrafosNormal')[0].addEventListener('dblclick',cambiarEstilos,false);
/**
